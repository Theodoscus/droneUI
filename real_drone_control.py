...
# Import our separated functions.
...
class DroneControlApp(QMainWindow):
    def __init__(self, field_path):
        ...
        # Create the Tello instance and wrap it with our DroneController.
        self.tello = Tello()
        self.drone_controller = DroneController(self.tello, self.flights_folder)

        # Flight/data states (UI‐managed)
        ...
        # Check the drone connection every 2 seconds
        ...
        # The stream_timer will be started after connection.

        # Build the UI (layout remains the same)
        self.init_ui()
        self.update_controller_status()

        # Immediately attempt to connect asynchronously.
    ...
    def handle_connect_success(self):
        ...
        # Start the video stream update timer.
    ...
    def update_video_stream(self):
        ...
        # Convert frame (assumed to be in RGB) to QImage and update label.
    ...
    # ---------------------------------------------------------------------
    # Movement (using our DroneController commands)
    # ---------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    field_path = os.path.abspath("fields/field1")  # or set your preferred path
